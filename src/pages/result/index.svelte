<div class="min-h-screen w-full flex flex-col items-center px-16 pb-16 bg-gray-100">
  <h1
  ...
  <div class="flex justify-between items-center w-full p-4 bg-white rounded-md shadow-md">
    <span class="text-2xl mplus ">Your average time was <span class="font-bold">{average}
        second. <span class="font-bold text-blue-600">{getMessage(average)}</span></span></span>
    <Button
      link={true}
      href="/"
      txt="Play Again"
      styles="bg-gray-900 text-white mplus px-4 py-2 self-start" />
  </div>
  <div class="flex flex-col items-center w-full p-4 bg-white rounded-md shadow-md mt-8">
